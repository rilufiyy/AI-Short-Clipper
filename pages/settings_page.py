...
class SettingsPage(ctk.CTkFrame):
    ...
    def create_main_page(self):
        ...
        # Row 3: Telegram, About
        self._create_setting_card(cards_frame, 2, 0, "📱", "Telegram", "Notifikasi selesai", "telegram")
        self._create_setting_card(cards_frame, 2, 1, "ℹ️", "About", "App info & updates", "about")
    ...
    def navigate_to_subpage(self, page_key):
        ...
        elif page_key == "telegram":
            from pages.settings.telegram_settings import TelegramSettingsSubPage
            TelegramSettingsSubPage(self.container, self.config, self._on_settings_saved, self.create_main_page)
        elif page_key == "about":
